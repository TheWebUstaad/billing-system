        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0"><i class="fas fa-plus me-2"></i>Item Details</h5>
                </div>
                <div class="card-body">
                    <?php echo form_open('inventory/add', ['class' => 'needs-validation', 'novalidate' => true]); ?>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control form-control-lg" id="title" name="title" required 
                                       value="<?php echo set_value('title'); ?>" placeholder="Enter item name">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group input-group-lg">
                                ...
                                <input type="number" class="form-control" id="price" name="price" 
                                       step="0.01" min="0" required value="<?php echo set_value('price'); ?>"
                                       placeholder="0.00">
                            </div>
                        ...
                        <div class="d-flex gap-3">
                            ...
                            <a href="<?php echo base_url('inventory'); ?>" class="btn btn-outline-secondary btn-lg">
